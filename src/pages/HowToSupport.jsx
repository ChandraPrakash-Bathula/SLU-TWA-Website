...
//   {
//     name: "Viceroy Development Group",
//     icon: <Building2 className="w-5 h-5" />,
//   },
...
//             Support the Transformative Workforce Academy
//           </h1>
...
//             <br />Whether you choose to volunteer your
//             time and skills, contribute through donations or sponsorships, or
//             explore employment opportunities within the program, your
//             involvement directly supports second chances and long-term success.
//             Your support helps us break barriers, build brighter futures, and
...
//               Coaching, administrative support, event volunteers — help prepare
//               jobseekers for stable employment.
...
//             <p className="text-sm text-gray-600 flex-1">
//               Sponsorships, donations, in-kind gifts — all help scale training
...
//                 Volunteer — Coaching & Events
//               </h3>
//             </div>
//             <p className="text-gray-700 mb-6">
//               Volunteers help jobseekers with resume prep, interview practice,
//               digital skills, and mock interviews. Volunteers also support data,
...
//                   Spring Second Chance Job Fair
//                 </div>
//                 <div className="text-sm">
//                   April — Chaifetz Arena (details TBA)
//                 </div>
//               </div>
//               <div className="p-4 rounded-lg bg-slate-50">
//                 <div className="font-semibold">
//                   Volunteer Training — Employer Guide
//                 </div>
...
//               </div>
//               <p className="text-gray-700 mb-6">
//                 Sponsorships fund career training, job fairs, apprenticeships,
//                 and employer engagement activities. Sponsorship tiers are
//                 flexible to meet organizational goals.
//               </p>
...
//               </div>
//               <p className="text-gray-700 mb-6">
//                 One-time gifts or recurring donations support wraparound
//                 services—transportation, work clothes, digital access, and
//                 training materials.
//               </p>
//               <div className="flex gap-3">
//                 <a
...
//             Join a mission-driven team or post meaningful job opportunities for
//             TWA participants. Lived experience is welcomed and valued.
//           </p>
